...
E_a_1_initial_guess =  33000     # J / mol
E_a_2_initial_guess =  77000       # J / mol
A_1_initial_guess = 1e10         # m ^ 3 / mol s
A_2_initial_guess = 3.5e6          # 1 / s4
alpha_initial_guess = 1            # reaction order
beta_initial_guess = 1             # reaction order
Ph_2_minus_initial = ph_abs[0]    # get from data
Ph_3_minus_initial = 0
...
variable = [1e6, 1e7, 1e8, 1e9, 1e10]

for i in variable:
    plt.plot(time, solve(i), linewidth = 3, color = "k")
