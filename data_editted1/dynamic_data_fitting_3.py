...
file_name = "3_sets_matched_clipped.csv"
...
E_a_1_initial_guess =  36000#35940.56     # J / mol
E_a_2_initial_guess =  77278 #77278       # J / mol
A_1_initial_guess = 0.114e7#0.114e6          # m ^ 3 / mol s
A_2_initial_guess = 1e10#3.06e9           # 1 / s4
...
Ph_2_minus_3_initial = ph_abs_3[0]    # get from data

Ph_3_minus_initial = 1.145565033 - ph_abs[0]
Ph_3_minus_initial_2 = 0.994207323 - ph_abs_2[0]
Ph_3_minus_initial_3 = 1.193916666 - ph_abs_3[0]
...
T_3 = reaction_model.Param(temperature_3)
...
Ph_2_minus_3.MEAS_GAP = 1e-3
Ph_2_minus_3.STATUS = 1           # regress to this value
Ph_2_minus_3.FSTATUS = 1          # take in data measurements
...
plt.plot(reaction_model.time, Ph_2_minus_3.value, linewidth = 3, color = "k", label ="Fit")
plt.scatter(reaction_model.time, ph_abs_3, label = "data")
#plt.plot(reaction_model.time, Ph_3_minus_2.value)
plt.title("Dynamic run 3")
plt.xlabel("Time")
plt.ylabel("Ph 2 minus")
plt.show()
...
plt.plot(reaction_model.time, T_3.value)
plt.xlabel("Time")
